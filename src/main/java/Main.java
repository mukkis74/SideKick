        ...
        do {
            ...
            switch (menuChoice) {
                case 1:
                     ...
                     *           action as required.
                     **/
                    sideKickObject.setChoice();     // Show options and get user's input
                    sideKickObject.takeAction();    // Act based on selected option
                    //break;
                ...
                case 2:
                     ...
                     *           action as required.
                     **/
                    driverBot.setChoice();     // Display WatADriver's menu
                    driverBot.takeAction();    // Execute the selected action
                    break;
